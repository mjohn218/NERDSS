...
Coord find_position_after_association(
    double alpha1, Coord Iface1, Coord Iface2, double alpha_total,
    double
        bindRadius);  // on sphere, when association, the new position of
                      // Iface1. alpha1 is the geodesic angle that Iface1 moves.

// Coord translate_on_sphere(Coord targ, Coord COM, Coord REF, Coord COMnew,
// Coord REFnew); // translation on sphere, output cardesian coords.
