...
/*!
 * \brief Create an Euler (Tait-Bryan angles) rotation matrix from x, y, z
 * values.
 */
std::array<double, 9> create_euler_rotation_matrix(double x, double y,
                                                   double z);

/*!
 * \brief Create an Euler (Tait–Bryan angles) rotation matrix from a Coord
 * containing angles of rotation.
 */
