// this file is copied from https://www.cnblogs.com/MakeView660/p/12531566.html,
// used for tracing function called
#pragma once
#ifndef TRACING_H
#define TRACING_H
...
class tracer {
 public:
  ...
  tracer(std::string const& fun, std::string const& file, int const line)
    ...
    std::clog << "TRACE: Entering function " << function_name << " ("
