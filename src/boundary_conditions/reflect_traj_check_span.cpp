 ...
 * ### Purpose: to check whether the complex.trajTrans and complex.trajRot will make the complex outside the box or sphere boundary
 * ***
 *
 * ### Notes
 * ***
...
//             reflect_traj_complex_rad_rot_nocheck(params, targCom, moleculeList, M, membraneObject, RS3Dinput);
//             ++checkItr;
