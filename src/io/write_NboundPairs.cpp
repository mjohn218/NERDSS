...
void write_NboundPairs(copyCounters& counterArrays, ofstream& outfile, int it,
  ...
  //         counterArrays.nBoundPairs[params.numMolTypes * params.numMolTypes +
  //         typeIndex] = 0;
  //     }
  ...
  outfile << counterArrays.nLoops << '\t' << counterArrays.nCancelOverlapPartner
          ...
          << counterArrays.nAssocSuccess << endl;
}
