 ...
 * ### Purpose: to calculate the new position after the translation and rotation
    ...
    const Complex targCom, const Coord ifacecrds)  // iface is cardesian coords
{
  ...
  double dangle = targCom.trajRot.x; // we select the rotation angle x as the
  angle that the complex rotate on the sphere
