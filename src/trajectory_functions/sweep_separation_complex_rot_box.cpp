...
void sweep_separation_complex_rot_box(
    ...
    for (unsigned memMolItr{0}; memMolItr < com1Size; ++memMolItr) {
      ...
      for (int crossMolItr{0};
        ...
        if (com1Index != com2Index) {
          ...
          double dx1{complexList[com1Index].comCoord.x + iface1Vec.x +
                     complexList[com1Index].trajTrans.x};
          double dy1{complexList[com1Index].comCoord.y + iface1Vec.y +
                     complexList[com1Index].trajTrans.y};
          double dz1{complexList[com1Index].comCoord.z + iface1Vec.z +
          ...
          double dx2{complexList[com2Index].comCoord.x + iface2Vec.x +
                     complexList[com2Index].trajTrans.x};
          double dy2{complexList[com2Index].comCoord.y + iface2Vec.y +
                     complexList[com2Index].trajTrans.y};
          double dz2{complexList[com2Index].comCoord.z + iface2Vec.z +
