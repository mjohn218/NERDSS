...
void sweep_separation_complex_rot_memtest_box(int simItr, int pro1Index, Parameters& params, std::vector<Molecule>& moleculeList, std::vector<Complex>& complexList, const std::vector<ForwardRxn>& forwardRxns, const std::vector<MolTemplate>& molTemplateList, const Membrane& membraneObject)
{
    /*
    ...
    */
    ...
    while (itr < maxItr) {
        ...
        if (hasOverlap) {
            ...
            reflect_traj_complex_rad_rot(params, moleculeList, complexList[comIndex1], membraneObject, RS3Dinput, isInsideCompartment);
            // reflectList[comIndex1] = 1;
            ...
            for (int checkMolItr { 0 }; checkMolItr < numOverlap; checkMolItr++) {
                ...
                if (resampleList[comIndex2] == 0) {
                     ...
                     */
                        ...
                        reflect_traj_complex_rad_rot(params, moleculeList, complexList[comIndex2], membraneObject, RS3Dinput, isInsideCompartment);
                        // reflectList[comIndex2] = 1;
