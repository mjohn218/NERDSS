								...
								*/
								...
								cancelDissociation
                                    = break_interaction(simItr, ifaceIndexA, ifaceIndexB, moleculeList[molIndexA], moleculeList[molIndexB],
														oneRxn, moleculeList, complexList, molTemplateList, membraneObject.implicitlipidIndex, forwardRxns[oneRxn.conjForwardRxnIndex], breakLinkComplex, params.timeStep);
